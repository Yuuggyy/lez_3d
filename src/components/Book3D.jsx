    ...
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 4 }}>
          ...
          <span style={{ flex: 1, borderBottom: `1.5px dotted rgba(201,169,110,0.30)`, position: 'relative', top: -3, minWidth: 8 }} />
      ...
      <div style={{
        ...
        {pages.map((p, i) => (
          <button key={i} onClick={() => setCurrent(i)} style={{
            ...
            transition: 'all 0.2s',
            boxShadow: i === current ? `0 2px 10px rgba(201,169,110,0.30)` : 'none',
          }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: 6, marginBottom: 14 }}>
        {pages.map((_, i) => (
          <div key={i} onClick={() => setCurrent(i)} style={{
            ...
            background: i === current ? C.gold : `rgba(201,169,110,0.25)`,
